...
export const createSolicitud = (data) => api.post("/solicitud-repuestos", data).then(res => {
  clearCachedValue('solicitud-repuestos:list');
  return res.data;
});
export const updateSolicitud = (id, data) => api.put(`/solicitud-repuestos/${id}`, data).then(res => {
  clearCachedValue('solicitud-repuestos:list');
  return res.data;
});
export const deleteSolicitud = (id) => api.delete(`/solicitud-repuestos/${id}`).then(res => {
  clearCachedValue('solicitud-repuestos:list');
  return res.data;
});